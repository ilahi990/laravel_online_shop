            ...
            <div class="row pb-3">
                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        <div class="left">
                            @if($category->image != "")
                            <img src="{{ asset('uploads/category/thumbs/'.$category->image) }}" alt="" class="img-fluid">
                            @endif
                        </div>
                        <div class="right">
                            <div class="cat-data">
                        ...
                        <div class="product-image position-relative">
                            <a href="{{ route('front.product',$product->slug) }}" class="product-img">
                             @if(!empty($productImage->image))
                                ...
                                @else
                                 <img class="card-img-top" src="{{ asset('uploads/products/small/profile.png') }}" class="img-thumbnail">
                             @endif    
                        ...
                        <div class="product-image position-relative">
                            <a href="{{ route('front.product',$product->slug) }}" class="product-img">
                             @if(!empty($productImage->image))
                                ...
                                @else
                                 <img class="card-img-top" src="{{ asset('uploads/products/small/profile.png') }}">
                             @endif    
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>                            
