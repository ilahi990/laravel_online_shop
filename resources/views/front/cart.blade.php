                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <img src="{{ asset('uploads/products/small/'.$item->options->productImage->image) }}" class="img-thumbnail">
                                            @else
                                            <img src="{{ asset('uploads/products/small/profile.png') }}" class="img-thumbnail">
                                             @endif 
                                            <h2>{{ $item->name }}</h2>
                                        </div>
                                    </td>
