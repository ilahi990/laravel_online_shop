	...
	<!-- Content Header (Page header) -->
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="{{ route('admin.sub-category.update', $subCategory->id)}}" method="post" name="subCategoryForm" id="subCategoryForm">
                                @csrf
                                <!-- @method('put') -->
						<div class="card">
							<div class="card-body">								
                                    ...
                                    <div class="col-md-12">
										<div class="mb-3">
                                            ...
                                            @if($categories->isNotEmpty())
                                                ...
                                                <option {{ ($subCategory->category_id == $category_id) ? 'selected' : ''}} value="{{ $category->id}}">{{ $category->name}}</option>
                                               @endforeach
                                               @endif
						...
						<div class="pb-5 pt-3">
							...
							<a href="{{ route('admin.sub-category.list') }}" class="btn btn-outline-dark ml-3">Cancel</a>
						</div>
                        </form>
					</div>
					<!-- /.card -->
