                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    rows="10" class="summernote" placeholder="Description">{{ $product->description }}</textarea>
                                                    <p class="error"></p>
                                                </div>
                                            </div>   
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    rows="10" class="summernote" placeholder="Description">{{ $product->shipping_returns }}</textarea>
                                                    <p class="error"></p>
                                                </div>
                                            </div>                                       
                                        </div>
...
const dropzone = $("#image").dropzone({
    url: "{{ route('admin.product-images.update') }}", // Correct URL for image upload
    maxFiles: 10,
    paramName: 'image',
    params: {'product_id': '{{ $product->id }}'},
    // Parameter name for the image
    addRemoveLinks: true,
